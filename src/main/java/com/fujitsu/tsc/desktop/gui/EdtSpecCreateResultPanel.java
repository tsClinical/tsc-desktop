...
public class EdtSpecCreateResultPanel extends JPanel {
	...
	public EdtSpecCreateResultPanel(GuiMain parent) {
		this.parent = parent;
        ...
        GroupLayout edtSpecCreatePanelLayout = new GroupLayout(this);
        this.setLayout(edtSpecCreatePanelLayout);
        edtSpecCreatePanelLayout.setHorizontalGroup(
        	edtSpecCreatePanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        edtSpecCreatePanelLayout.setVerticalGroup(
       		edtSpecCreatePanelLayout.createSequentialGroup()
	...
	private void initBodyPanel() {
		...
		gResultMessage.setText("Create eDT Spec Log:");
...
//        /* Set the editor pane as the log output destination of the define.xml generator. */
//        EditorPaneAppender epAppender = new EditorPaneAppender();
//        epAppender.setEditorPane(gResultEditorPane);
